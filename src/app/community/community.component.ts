...
export class CommunityComponent{
  masterCommunityList: Community[] = [
    new Community("World War Two Reenacting", "Come out to the community center with us this Saturday for make fake war.", "http://i219.photobucket.com/albums/cc203/Pounce_the_jaguar/073.jpg", "stooge234"),
